        ...
        <div className="bg-gray-100 flex flex-col justify-center items-center w-fit relative z-30 ">
            ...
            <div
               ...
               <span>{selectedCity}</span>
                <BsChevronExpand className="text-grey-400"/>
            </div>

        <div className={`flex flex-col bg-white w-48 my-2 rounded-lg ${
            ...
            {cities.map(item =>(
                ...
                >
                    <AiOutlineCheck className={`text-orange-300 ${selectedCity === item? "opacity-100" : "opacity-0"}`} />
                    <span>
                        {item}
                    </span>
                </div>
